...
const REL = {
  ...
  pdftopng: { href: '/pdf-to-png', label: 'Convert PDF pages to PNG' },
  watermark: { href: '/watermark-pdf', label: 'Add a watermark to a PDF' },
  pagenumbers: { href: '/add-page-numbers', label: 'Add page numbers to a PDF' },
  sign: { href: '/sign-pdf', label: 'Sign a PDF' },
...
export const TOOLS: Record<string, ToolContent> = {
  ...
  edit: {
    ...
    related: [REL.merge, REL.split, REL.sign, REL.watermark],
  },
  ...
  watermark: {
    ...
    slug: '/watermark-pdf',
    wide: true,
    title: 'Add Watermark to PDF Free — No Upload | DocLab',
    description:
      'Add a text watermark to every page of a PDF, free and in your browser. Set the text, size, and opacity, then download. Nothing is uploaded; no account.',
    h1: 'Add Watermark to PDF',
    lead: `Add a watermark to a PDF for free, entirely in your browser. Type the text you want — DRAFT, CONFIDENTIAL, your name — set the size and opacity, and it's stamped diagonally across every page. The file is processed on your device and never uploaded.`,
    steps: [
      { name: 'Open your PDF', text: 'Drag a PDF onto the page or click Choose a PDF; it loads with a thumbnail of every page.' },
      { name: 'Open the Watermark tool', text: 'Pick Watermark, type your text, and adjust the font size and opacity to taste.' },
      { name: 'Apply and download', text: 'Apply stamps the watermark onto every page, then Download saves the watermarked PDF to your device.' },
    ],
    why: [
      'Free with no account, sign-up, or DocLab watermark of its own',
      'Choose the text, size, and opacity',
      'Applies to every page in one step',
      'Files never leave your device — nothing is uploaded',
      'No page or file-size limits',
      'Works on Windows, Mac, Linux, ChromeOS, and mobile',
    ],
    privacy: `Watermarking runs on your own machine. Your PDF is read into the browser, the watermark text is drawn onto each page locally, and the result is handed back as a download — there is no upload and no server that ever sees the document. A strict Content-Security-Policy blocks the page from sending your file anywhere, and once it has loaded the tool keeps working offline. Because the web tools are open source, you can confirm the watermark is added on-device and nothing is transmitted. That makes it safe for stamping CONFIDENTIAL or DRAFT onto sensitive contracts without handing them to a third party.`,
    faqs: [
      { q: 'Are my files uploaded when I add a watermark?', a: 'No. The watermark is drawn onto your PDF locally in your browser; the file is never sent to a server or stored anywhere.' },
      { q: 'Is it free, and do I need an account?', a: "Yes, it's completely free with no account or sign-up, and no DocLab branding is added — only the watermark text you choose." },
      { q: 'Can I control where the watermark appears?', a: 'You set the text, size, and opacity, and it is tiled/centered across every page. For per-page placement or image watermarks, use the full editor or the desktop app.' },
      { q: 'Does it work offline and on mobile?', a: 'Yes. It runs in any modern browser on Windows, Mac, Linux, ChromeOS, and phones, and keeps working with no connection once the page has loaded.' },
      { q: 'Can the watermark be removed later?', a: 'It is drawn into the page content, so it is not a one-click toggle to remove. Keep your original file if you need an unmarked copy.' },
    ],
    related: [REL.pagenumbers, REL.sign, REL.edit, REL.merge],
  },
  ...
  pagenumbers: {
    ...
    wide: true,
    title: 'Add Page Numbers to PDF Free — No Upload | DocLab',
    description:
      'Add page numbers to a PDF free, right in your browser. Choose the position and starting number, then download. Nothing is uploaded, no account, no limits.',
    h1: 'Add Page Numbers to PDF',
    lead: `Add page numbers to a PDF for free, entirely in your browser. Pick a position — bottom-center, corners, or top — and the numbers are stamped onto every page. Your file is processed on your device and never uploaded.`,
    steps: [
      { name: 'Open your PDF', text: 'Drag in or choose a PDF; every page appears as a thumbnail.' },
      { name: 'Choose a position', text: 'Open the Page numbers tool and pick where the number sits (bottom center, bottom right, top, and so on).' },
      { name: 'Apply and download', text: 'Apply numbers every page, then download the numbered PDF to your device.' },
    ],
    why: [
      'Free with no account or sign-up',
      'Choose corner or center placement',
      'Numbers stamp onto every page in one step',
      'Nothing is uploaded — your file stays on your device',
      'No page or file-size limits',
      'Works on Windows, Mac, Linux, ChromeOS, and mobile',
    ],
    privacy: `Page numbers are added on your own device. The PDF is opened in your browser, the numbers are drawn onto each page locally, and the file is saved straight to your downloads — there is no upload step and no server involvement. A strict Content-Security-Policy prevents the page from transmitting your document, the tool works offline once loaded, and the code is open source so you can verify it. Numbering a confidential report or contract here never exposes it to a third party.`,
    faqs: [
      { q: 'Are my files uploaded to add page numbers?', a: 'No. Numbering happens locally in your browser; the PDF is never sent to a server.' },
      { q: 'Is it free, and do I need an account?', a: "Yes — completely free, no account, no sign-up, and no watermark added." },
      { q: 'Can I start numbering from a specific number or page?', a: 'You choose the position; the full editor lets you combine numbering with other edits. For complex schemes (skip the cover, Roman numerals), the desktop app has more control.' },
      { q: 'Does it work offline and on a phone?', a: 'Yes. It runs in any modern browser on desktop and mobile, and keeps working without a connection after the page loads.' },
      { q: 'Will the numbers overlap my content?', a: 'They sit in the margin at the position you choose. Pick a corner if your pages are dense near the bottom-center.' },
    ],
    related: [REL.watermark, REL.edit, REL.merge, REL.sign],
  },
  ...
  sign: {
    ...
    steps: [
      { name: 'Open your PDF', text: 'Drag in or choose the PDF you need to sign; it opens with a large page view.' },
      { name: 'Create your signature', text: 'Open the Sign tool and draw, type, or upload your signature — it becomes a transparent stamp.' },
      { name: 'Place and resize', text: 'Click the page to drop your signature, then drag it or a corner handle to position and size it. Add it to more pages if needed.' },
      { name: 'Download', text: 'Download the signed PDF with your signature baked in.' },
    ],
    why: [
      'Three ways to sign: draw, type, or upload an image',
      'Move and resize the signature exactly where you want it',
      'Place it on one page or several',
      'Free with no account and no watermark',
      'Nothing is uploaded — your document stays private',
      'Works on Windows, Mac, Linux, ChromeOS, and mobile (sign with your finger)',
    ],
    privacy: `Signing happens entirely in your browser. Your PDF and your signature image are processed on your own device — the signature is drawn onto the page locally and the result is saved straight to your downloads, with no upload and no server ever receiving the file. A strict Content-Security-Policy blocks any outbound transfer, the tool runs offline once loaded, and the web tools are open source so you can verify that your signed contract or form never leaves your computer. For a legally heavier workflow you may still want a dedicated e-signature service, but for adding your own signature privately, nothing leaves your device.`,
    faqs: [
      { q: 'Is my document uploaded when I sign it?', a: 'No. Your PDF and signature are handled locally in your browser and are never sent to a server.' },
      { q: 'Is it free, and do I need an account?', a: 'Yes, completely free with no account or sign-up, and no watermark on the signed file.' },
      { q: 'How can I create the signature?', a: 'Three ways: draw it with a mouse or finger, type your name in a handwriting font, or upload a PNG/JPG of your signature. All become a transparent stamp you can place and resize.' },
      { q: 'Is this a legally binding e-signature?', a: 'It adds a visible signature image to the PDF. It is not a certificate-based digital signature; for regulated e-signing with audit trails, use a dedicated e-signature provider.' },
      { q: 'Does it work on a phone?', a: 'Yes — on a touch device you can draw your signature directly with your finger, then place and resize it.' },
    ],
    related: [REL.edit, REL.watermark, REL.pagenumbers, REL.merge],
  },
  ...
  pdftopng: {
    ...
    slug: '/pdf-to-png',
    wide: true,
    title: 'PDF to PNG Free — No Upload | DocLab',
    description:
      'Convert PDF pages to PNG images free, in your browser. Crisp, lossless PNGs — multi-page files download as a zip. Nothing is uploaded; no account needed.',
    h1: 'PDF to PNG',
    lead: `Convert a PDF to PNG images for free, right in your browser. Open the file, export each page as a sharp, lossless PNG, and a multi-page PDF comes back as a tidy zip. Every page is rendered on your own device, so even sensitive documents never leave your computer.`,
    steps: [
      { name: 'Open your PDF', text: 'Drag a PDF onto the editor or choose one; each page shows as a thumbnail.' },
      { name: 'Choose PNG and a resolution', text: 'Open To images, pick PNG, and select Standard or High resolution.' },
      { name: 'Export and download', text: 'Export: a single page saves as one PNG, and multiple pages download together as a .zip.' },
    ],
    why: [
    ...
    privacy: `The conversion runs entirely in your browser. When you open a PDF, each page is rendered to a PNG on your own device — there is no server, no upload, and no copy of your file kept anywhere online. A strict Content-Security-Policy blocks the page from shipping your document out, and once it has loaded you can convert with the network off. Because the web tools are open source, you can read the code and confirm it. That makes it a private way to turn confidential pages into PNG images offline.`,
    faqs: [
      { q: 'Are my files uploaded to convert to PNG?', a: 'No. Pages are rendered to PNG directly in your browser; nothing is sent to a server, and it works offline after the page loads.' },
      { q: 'Is it free, and do I need an account?', a: 'Yes — free, no account, no email, and no watermark on the images.' },
      { q: 'PNG or JPG — which should I pick?', a: 'PNG is lossless with sharp text and transparency, best for documents and graphics; JPG makes smaller, photo-style files. Use the PDF to JPG tool if you prefer JPG.' },
      { q: 'How do the images download?', a: 'A single page saves as one PNG; multiple pages download as a zip, numbered in page order.' },
      { q: 'Does it work on Mac and mobile?', a: 'Yes, in any modern browser on Windows, Mac, Linux, ChromeOS, and phones or tablets.' },
    ],
    related: [REL.topng, REL.images, REL.edit, REL.split],
  },
};
